...
import com.chaung.kafka.config.audit.AuditEventConverter;
import com.chaung.kafka.domain.PersistentAuditEvent;
...
import static com.chaung.kafka.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
